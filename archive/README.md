...
| `components/board/CellCard.tsx`, `components/board/TowerCard.tsx` | The panels a tapped cell or tower opened at the foot of the board: owner, score, block count and buttons. Replaced (2026-09) by tags written on the world over the thing itself (`components/board/WorldTags.tsx`) and its one action at the foot (`components/board/briefs.ts`). |
